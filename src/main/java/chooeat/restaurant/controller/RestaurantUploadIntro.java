...
@WebServlet("/restaurant/restaurantuploadintro")
public class RestaurantUploadIntro extends HttpServlet {
	 @Autowired
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String b = request.getParameter("intro");
		
	
        int ooo=RestaurantService.restaurantuploadintro(a,b);    
