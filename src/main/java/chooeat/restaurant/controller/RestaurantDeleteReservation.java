...
@WebServlet("/restaurant/restaurantdeletereservation")
public class RestaurantDeleteReservation extends HttpServlet {
	 @Autowired
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String a = request.getParameter("reservationId");
		String b = request.getParameter("restaurantId");	
				
		int c=RestaurantService.restaurantdeletereservation(a,b);
