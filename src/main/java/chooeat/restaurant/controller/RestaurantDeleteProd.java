...
@WebServlet("/restaurant/restaurantdeleteprod")
public class RestaurantDeleteProd extends HttpServlet {
	 @Autowired
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String a = request.getParameter("prodName");
		String b = request.getParameter("restaurantId");				
		int c=RestaurantService.restaurantdeleteprod(a,b);
