...
@WebServlet("/restaurant/restaurantdeletead")
public class RestaurantDeleteAd extends HttpServlet {
	 @Autowired
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String a = request.getParameter("adId");
		String b = request.getParameter("restaurantId");				
		int c=RestaurantService.restaurantdeletead(a,b);
