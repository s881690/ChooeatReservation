...
@WebServlet("/restaurant/restaurantuploaddayoff")
public class RestaurantUploadDayoff extends HttpServlet {
	 @Autowired
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String b = request.getParameter("dates");

		int c = RestaurantService.restaurantuploaddayoff(a, b);
