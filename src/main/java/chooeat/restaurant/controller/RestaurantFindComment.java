...
@WebServlet("/restaurant/restaurantfindcomment")
public class RestaurantFindComment extends HttpServlet {
	 @Autowired
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Map<String, Object> d = RestaurantService.restaurantfindcomment(a);
