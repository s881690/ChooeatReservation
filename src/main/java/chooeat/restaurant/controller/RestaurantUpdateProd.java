...
@WebServlet("/restaurant/restaurantupdateprod")
public class RestaurantUpdateProd extends HttpServlet {
	 @Autowired
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String b = request.getParameter("prodName");		
		String c = request.getParameter("prodPrice");
		String d = request.getParameter("prodQty");
		String e = request.getParameter("prodUserGuide");		
		String f = request.getParameter("prodText");
		String g = request.getParameter("prodState");
		String h = request.getParameter("prodId");		
		int j=RestaurantService.restaurantupdateprod(a,b,c,d,e,f,g,h);
