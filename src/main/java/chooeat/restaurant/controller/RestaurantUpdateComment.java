...
@WebServlet("/restaurant/restaurantupdatecomment")
public class RestaurantUpdateComment extends HttpServlet {
	 @Autowired
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String a = request.getParameter("accName");
		String b = request.getParameter("restaurantId");		
		String c = request.getParameter("commentInput");	
		 
		int e=RestaurantService.restaurantupdatecomment(a,b,c);		
		Gson gson = new Gson();
